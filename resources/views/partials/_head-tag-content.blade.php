...
<script src="{{ URL::to('dist/js/js-agent-newrelic.min.js') }}"></script>
...
<link rel="stylesheet" media="screen" href="{{ URL::to('dist/css/page_scrolling_gallery.css') }}" />
<link rel="stylesheet" type='text/css' media="screen" href="{{ URL::to('dist/css/scrolling-gallery.php') }}" />
<link rel="stylesheet" media="screen" href="{{ URL::to('dist/css/pages_aspect_ratio_scrolling_top.css') }}" />
<link rel="stylesheet" media="screen" href="{{ URL::to('dist/css/site-classic-main.css') }}" />
<link rel="stylesheet" media="screen" href="{{ URL::to('dist/css/social-icons.css') }}" />
